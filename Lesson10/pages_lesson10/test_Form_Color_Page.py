...
@allure.story("Color of cells in the form")

class FormColorPage:
    def __init__(self, browser):
        self.driver = browser

    @allure.step("Specifies the color of the ZIP-COD cell")
    ...
    @allure.step("Specifies the color of the NAME cell")
    ...
    @allure.step("Specifies the color of the LAST NAME cell")
    ...
    @allure.step("Specifies the color of the ADDRESS cell")
    ...
    @allure.step("Specifies the color of the CITY cell")
    ...
    @allure.step("Specifies the color of the COUNTRY cell")
    ...
    @allure.step("Specifies the color of the PHON cell")
    ...
    @allure.step("Specifies the color of the JOB cell")
    ...
    @allure.step("Specifies the color of the COMPANY cell")
